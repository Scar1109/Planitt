...
def main():
    ...
    # Dataset is at ../../../Dataset relative to src (PythonModels/PromotionForecasting/src)
    dataset_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "../../Dataset")) # Actually ../../ is PythonModels/Dataset. User confirmed Dataset is at ../../../Dataset relative to scripts. Scripts was at PromotionForecasting/scripts. Src is at PromotionForecasting/src. So depth is same.
