      ...
      <button onClick={() => setExpanded(v => !v)}
        ...
        <div className="flex items-center gap-3">
          <div className="w-7 h-7 rounded-lg bg-[#1B4F72]/10 flex items-center justify-center">
            <Cpu size={13} className="text-[#1B4F72]" />
          </div>
          <div className="text-left">
            <p className="text-sm font-bold text-slate-800">How AI Recommendations Are Generated</p>
            <p className="text-xs text-slate-400">MIP Solver · Random Forest · S-Learner XGBoost · GPT-4o Narrator</p>
          </div>
        </div>
