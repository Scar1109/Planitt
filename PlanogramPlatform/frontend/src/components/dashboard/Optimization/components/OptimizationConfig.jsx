                ...
                <div className="space-y-4">
                    ...
                    {config.scope?.type === 'fixture' && (
                        <div className="animate-in fade-in slide-in-from-top-2 duration-200">
                            ...
                            <select
                                className="w-full text-sm p-2.5 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none"
            ...
            <div className="mb-8">
                ...
                <div className="grid grid-cols-3 gap-3">
                    <button
                        ...
                        className={`p-4 rounded-xl border text-left transition-all ${config.runType === 'fast' ? 'border-indigo-500 bg-indigo-50 ring-1 ring-indigo-500' : 'border-slate-200 hover:border-slate-300'}`}
                    >
                        <FaRocket className={`mb-2 ${config.runType === 'fast' ? 'text-indigo-600' : 'text-slate-400'}`} />
                    ...
                    <button
                        ...
                        className={`p-4 rounded-xl border text-left transition-all ${config.runType === 'balanced' ? 'border-indigo-500 bg-indigo-50 ring-1 ring-indigo-500' : 'border-slate-200 hover:border-slate-300'}`}
                    >
                        <FaBalanceScale className={`mb-2 ${config.runType === 'balanced' ? 'text-indigo-600' : 'text-slate-400'}`} />
                    ...
                    <button
                        ...
                        className={`p-4 rounded-xl border text-left transition-all ${config.runType === 'deep' ? 'border-indigo-500 bg-indigo-50 ring-1 ring-indigo-500' : 'border-slate-200 hover:border-slate-300'}`}
                    >
                        <FaBrain className={`mb-2 ${config.runType === 'deep' ? 'text-indigo-600' : 'text-slate-400'}`} />
                ...
                <div className="space-y-6">
                    <div>
                        <div className="flex justify-between mb-2">
                            ...
                            <span className="text-xs font-bold text-indigo-600">{config.objectiveWeights.sales * 100}%</span>
                        </div>
                        <input
                    ...
                    <div>
                        <div className="flex justify-between mb-2">
                            ...
                            <span className="text-xs font-bold text-indigo-600">{config.objectiveWeights.space * 100}%</span>
                        </div>
                        <input
                            type="range" min="0" max="1" step="0.1"
